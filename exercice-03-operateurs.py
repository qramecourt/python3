...
print("there wil be " + str(candies_rest) + " candies and " + str(chocolates_rest) + " rest") 
# exo 3.3
...
print("if we divide equally, we will have " + str(candies_per_person) + " candies and " + str(chocolates_per_person) + 
" chocolates per person")
# exo 3.4
# Calculez la moyenne des nombres suivants : 1, 1, 2, 3, 5, 8, 13.
# Affectez le résultat à une variable et affichez le résultat.

# réponse 3.4
avg = (1 + 1 + 2 + 3 + 5 + 8 + 12) / 7
print(avg)
# exo 3.5
